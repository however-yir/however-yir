...
| [ragproof](https://github.com/however-yir/ragproof) | Framework-agnostic RAG evaluation CLI: recall@k, MRR, faithfulness, citation metrics, regression gates and CI integration. | [Demo](https://github.com/however-yir/ragproof#run-a-gate-in-30-seconds) · [Design](https://github.com/however-yir/ragproof/blob/main/docs/ARCHITECTURE.md) · [Evidence](https://github.com/however-yir/ragproof/blob/main/docs/PUBLIC_BENCHMARK_REPORT.md) |
